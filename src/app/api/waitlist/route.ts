...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("Attempting to add to Airtable:", { email, name, company })
    ...
    if (RESEND_API_KEY) {
      try {
        const emailResponse = await fetch("https://api.resend.com/emails", {
          ...
          body: JSON.stringify({
            from: "Sleft Signals <hello@sleftsignals.com>",
            to: [email],
            subject: "🚀 Welcome to Sleft Signals - You're In!",
            html: `
              <!DOCTYPE html>
              <html>
              <head>
                ...
                <title>Welcome to Sleft Signals</title>
              </head>
              <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
                <div style="background: linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%); padding: 40px 20px; text-align: center; border-radius: 12px; margin-bottom: 30px;">
                  ...
                  <p style="color: #000; font-size: 18px; margin: 10px 0 0 0; opacity: 0.8;">Welcome to the future of business intelligence</p>
                </div>
                ...
                <div style="background: #f8f9fa; padding: 30px; border-radius: 12px; margin-bottom: 30px;">
                  ...
                  <div style="margin-bottom: 20px;">
                    ...
                    <p style="margin-left: 45px; color: #666; margin-bottom: 0;">You'll be among the first to know when Sleft Signals launches</p>
                  </div>
                  ...
                  <div style="margin-bottom: 20px;">
                    <div style="display: flex; align-items: center; margin-bottom: 15px;">
                      ...
                      <span style="font-weight: 600;">Exclusive Beta Access</span>
                    </div>
                    <p style="margin-left: 45px; color: #666; margin-bottom: 0;">Get free access to test our AI-powered business intelligence platform</p>
                  </div>
                  ...
                  <div>
                    <div style="display: flex; align-items: center; margin-bottom: 15px;">
                      ...
                      <span style="font-weight: 600;">Strategic Insights</span>
                    </div>
                    <p style="margin-left: 45px; color: #666; margin-bottom: 0;">Receive your first AI-generated business strategy brief - completely free</p>
                  </div>
                </div>
                ...
                <div style="background: #1a1a1a; color: #fff; padding: 30px; border-radius: 12px; text-align: center;">
                  ...
                  <ul style="list-style: none; padding: 0; text-align: left;">
                    <li style="margin-bottom: 10px;">✅ AI-powered competitive analysis</li>
                    <li style="margin-bottom: 10px;">✅ Strategic partnership recommendations</li>
                    <li style="margin-bottom: 10px;">✅ Growth opportunity identification</li>
                    <li style="margin-bottom: 10px;">✅ Market intelligence insights</li>
                    <li style="margin-bottom: 10px;">✅ Business connection facilitation</li>
                  </ul>
                </div>
                ...
                <div style="text-align: center; margin-top: 30px; padding-top: 30px; border-top: 1px solid #eee;">
                  <p style="color: #666; font-size: 14px;">
                    ...
                    <strong>Team Sleft Signals</strong>
                  </p>
                  <p style="color: #999; font-size: 12px; margin-top: 20px;">
                    You're receiving this because you signed up for early access to Sleft Signals.<br>
